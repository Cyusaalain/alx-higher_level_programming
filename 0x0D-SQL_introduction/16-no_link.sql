...
LIST_RECORDS_QUERY="/* List records from second_table in $DATABASE_NAME */ USE $DATABASE_NAME; SELECT score, name FROM second_table WHERE name IS NOT NULL ORDER BY score DESC;"
